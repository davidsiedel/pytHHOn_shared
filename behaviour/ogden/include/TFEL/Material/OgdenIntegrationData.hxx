/*!
* \file   TFEL/Material/OgdenIntegrationData.hxx
* \brief  this file implements the OgdenIntegrationData class.
*         File generated by tfel version 4.0.0-dev
* \author Thomas Helfer
* \date   20 / 12 / 2016
 */

#ifndef LIB_TFELMATERIAL_OGDEN_INTEGRATION_DATA_HXX
#define LIB_TFELMATERIAL_OGDEN_INTEGRATION_DATA_HXX
...
std::ostream&
 operator <<(std::ostream&,const OgdenIntegrationData<hypothesis,Type,false>&);

template<ModellingHypothesis::Hypothesis hypothesis,typename Type>
class OgdenIntegrationData<hypothesis,Type,false>
{
...
friend std::ostream& operator<< <>(std::ostream&,const OgdenIntegrationData&);
...
*/
OgdenIntegrationData()
{}

/*!
* \brief Copy constructor
*/
OgdenIntegrationData(const OgdenIntegrationData& src)
: F1(src.F1),
dt(src.dt),
dT(src.dT)
{}
 ...
 */
OgdenIntegrationData(const mfront::gb::BehaviourData& mgb_d)
: dt(mgb_d.dt),
...
OgdenIntegrationData&
>::type
scale(const OgdenBehaviourData<hypothesis,Type,false>& behaviourData, const Scal time_scaling_factor){
...
*/
OgdenIntegrationData&
updateDrivingVariables(const OgdenBehaviourData<hypothesis,Type,false>& behaviourData){
this->F1 += this->F1 - (behaviourData.F0);
return *this;
}

}; // end of OgdenIntegrationDataclass

template<ModellingHypothesis::Hypothesis hypothesis,typename Type>
std::ostream&
operator <<(std::ostream& os,const OgdenIntegrationData<hypothesis,Type,false>& b)
{
os << "F₁ : " << b.F1 << '\n';
os << "σ : " << b.sig << '\n';
os << "Δt : " << b.dt << '\n';
...
#endif /* LIB_TFELMATERIAL_OGDEN_INTEGRATION_DATA_HXX */
