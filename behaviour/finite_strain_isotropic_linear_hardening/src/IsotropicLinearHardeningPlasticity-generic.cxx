...
MFRONT_SHAREDOBJ const char *
IsotropicLinearHardeningPlasticity_src = "FiniteStrainIsotropicLinearHardeningPlasticity.mfront";
...
MFRONT_SHAREDOBJ int IsotropicLinearHardeningPlasticity_GradientsTypes[1] = {3};
MFRONT_SHAREDOBJ const char * IsotropicLinearHardeningPlasticity_Gradients[1] = {"DeformationGradient"};
...
MFRONT_SHAREDOBJ unsigned short IsotropicLinearHardeningPlasticity_nTangentOperatorBlocks = 2u;

MFRONT_SHAREDOBJ const char * IsotropicLinearHardeningPlasticity_TangentOperatorBlocks[2] = {"Stress",
"DeformationGradient"};
MFRONT_SHAREDOBJ unsigned short IsotropicLinearHardeningPlasticity_BehaviourType = 2u;

MFRONT_SHAREDOBJ unsigned short IsotropicLinearHardeningPlasticity_BehaviourKinematic = 3u;
...
MFRONT_SHAREDOBJ unsigned short IsotropicLinearHardeningPlasticity_nMaterialProperties = 0u;

MFRONT_SHAREDOBJ const char * const *IsotropicLinearHardeningPlasticity_MaterialProperties = nullptr;
...
MFRONT_SHAREDOBJ unsigned short IsotropicLinearHardeningPlasticity_nParameters = 6;
MFRONT_SHAREDOBJ const char * IsotropicLinearHardeningPlasticity_Parameters[6] = {"YoungModulus",
"PoissonRatio","HardeningSlope","YieldStrength","minimal_time_step_scaling_factor","maximal_time_step_scaling_factor"};
MFRONT_SHAREDOBJ int IsotropicLinearHardeningPlasticity_ParametersTypes [] = {0,0,0,0,0,0};

MFRONT_SHAREDOBJ double IsotropicLinearHardeningPlasticity_YoungModulus_ParameterDefaultValue = 70000000000;

MFRONT_SHAREDOBJ double IsotropicLinearHardeningPlasticity_PoissonRatio_ParameterDefaultValue = 0.34;

MFRONT_SHAREDOBJ double IsotropicLinearHardeningPlasticity_HardeningSlope_ParameterDefaultValue = 10000000000;

MFRONT_SHAREDOBJ double IsotropicLinearHardeningPlasticity_YieldStrength_ParameterDefaultValue = 300000000;
