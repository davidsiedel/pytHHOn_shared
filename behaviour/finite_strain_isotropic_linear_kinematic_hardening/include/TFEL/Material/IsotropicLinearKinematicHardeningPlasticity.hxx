...
#line 12 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
StrainStensor deel;
#line 14 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
StrainStensor da;

#line 25 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
StressStensor sig0;
#line 26 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
Stensor n;
#line 27 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
stress lambda;
#line 28 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
stress mu;
#line 29 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
stress seq;
#line 30 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
strain dp;
#line 31 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
bool b;

#line 16 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
real young;
#line 18 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
real nu;
#line 20 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
real s0;
#line 22 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
real C;
...
using namespace tfel::math;
using std::vector;
#line 34 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
this->lambda = computeLambda(this->young,this->nu);
#line 35 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
this->mu     = computeMu(this->young,this->nu);
#line 36 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
this->sig0   = this->sig;
}
...
#line 40 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
...
#line 44 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
this->eel += this->deto;
#line 45 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
const auto X  = 2*this->C*this->a/3;
#line 46 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
const auto s  = 2*this->mu*deviator(this->eel)-X;
#line 47 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
this->seq = sigmaeq(s);
#line 48 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
this->b   = this->seq-this->s0>stress{0};
#line 49 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
if(this->b){
#line 50 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
this->n    = (3*s)/(2*this->seq);
#line 51 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
this->dp   = (this->seq-this->s0)/(3*this->mu+this->C);
#line 52 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
this->a   += this->dp*this->n;
#line 53 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
this->eel -= this->dp*this->n;
#line 54 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
}
#line 55 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
...
using namespace std;
using namespace tfel::math;
#line 68 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
const auto tr = trace(this->eel);
#line 69 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
...
using namespace std;
using namespace tfel::math;
#line 73 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
...
using namespace tfel::math;
using std::vector;
#line 59 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
if((smt==CONSISTENTTANGENTOPERATOR)&&(this->b)){
#line 60 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
this->Dt = (this->lambda*Stensor4::IxI()+2*this->mu*Stensor4::Id()
#line 61 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
-4*this->mu*this->mu*((this->dp/this->seq)*(Stensor4::M()-(this->n^this->n))+(this->n^this->n)/(3*this->mu+this->C)));
#line 62 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
} else {
#line 63 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
this->Dt = this->lambda*Stensor4::IxI()+2*this->mu*Stensor4::Id();
#line 64 "FiniteStrainIsotropicLinearKinematicHardeningPlasticity.mfront"
}
return true;
}
