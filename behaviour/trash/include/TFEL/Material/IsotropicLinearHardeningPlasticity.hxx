...
#line 16 "test2.mfront"
StrainStensor deel;
#line 18 "test2.mfront"
strain dp;


#line 21 "test2.mfront"
real young;
#line 23 "test2.mfront"
real nu;
#line 25 "test2.mfront"
real H;
#line 27 "test2.mfront"
real s0;
...
#line 49 "test2.mfront"
const auto lambda = computeLambda(this->young,this->nu);
#line 50 "test2.mfront"
const auto mu     = computeMu(this->young,this->nu);
#line 51 "test2.mfront"
this->eel += this->deto;
#line 52 "test2.mfront"
const auto se     = 2*mu*deviator(this->eel);
#line 53 "test2.mfront"
const auto seq_e  = sigmaeq(se);
#line 54 "test2.mfront"
const auto b      = seq_e-this->s0-this->H*this->p>stress{0};
#line 55 "test2.mfront"
if(b){
#line 56 "test2.mfront"
const auto iseq_e = 1/seq_e;
#line 57 "test2.mfront"
const auto n      = eval(3*se/(2*seq_e));
#line 58 "test2.mfront"
const auto cste   = 1/(this->H+3*mu);
#line 59 "test2.mfront"
this->dp   = (seq_e-this->s0-this->H*this->p)*cste;
#line 60 "test2.mfront"
this->eel -= this->dp*n;
#line 61 "test2.mfront"
if(computeTangentOperator_){
#line 62 "test2.mfront"
if(smt==CONSISTENTTANGENTOPERATOR){
#line 63 "test2.mfront"
this->Dt = (lambda*Stensor4::IxI()+2*mu*Stensor4::Id()
#line 64 "test2.mfront"
-4*mu*mu*(this->dp*iseq_e*(Stensor4::M()-(n^n))+cste*(n^n)));
#line 65 "test2.mfront"
} else {
#line 66 "test2.mfront"
this->Dt = lambda*Stensor4::IxI()+2*mu*Stensor4::Id();
#line 67 "test2.mfront"
}
#line 68 "test2.mfront"
}
#line 69 "test2.mfront"
} else {
#line 70 "test2.mfront"
if(computeTangentOperator_){
#line 71 "test2.mfront"
this->Dt = lambda*Stensor4::IxI()+2*mu*Stensor4::Id();
#line 72 "test2.mfront"
}
#line 73 "test2.mfront"
}
#line 74 "test2.mfront"
