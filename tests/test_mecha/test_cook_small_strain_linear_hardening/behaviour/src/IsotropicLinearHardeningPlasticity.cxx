...
pi.young = IsotropicLinearHardeningPlasticityParametersInitializer::getDouble(tokens[0],tokens[1]);
} else if("PoissonRatio"==tokens[0]){
pi.nu = IsotropicLinearHardeningPlasticityParametersInitializer::getDouble(tokens[0],tokens[1]);
} else if("HardeningSlope"==tokens[0]){
pi.H = IsotropicLinearHardeningPlasticityParametersInitializer::getDouble(tokens[0],tokens[1]);
} else if("YieldStrength"==tokens[0]){
pi.s0 = IsotropicLinearHardeningPlasticityParametersInitializer::getDouble(tokens[0],tokens[1]);
