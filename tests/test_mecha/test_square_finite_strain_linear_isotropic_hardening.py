...
class TestMecha(TestCase):
    def test_square_finite_strain_linear_hardening(self):
        # --------------------------------------------------------------------------------------------------------------
        # POLYNOMIAL ORDER
        # --------------------------------------------------------------------------------------------------------------
        polynomial_order = 1
        ...
        # stabilization_parameter = 1.e0 * parameters["YoungModulus"]
        ...
        mtest_file_path = (
            "/home/dsiedel/Projects/pythhon/behaviour/testfront/finite_strain_isotropic_linear_hardening.res"
        )
