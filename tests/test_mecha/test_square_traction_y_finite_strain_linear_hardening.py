...
class TestMecha(TestCase):
    def test_square_traction_y_finite_strain_linear_hardening(self):
        ...
        mtest_file_path = (
            "/home/dsiedel/Projects/pythhon/behaviour/testfront/traction_y_finite_strain_isotropic_linear_hardening.res"
        )
        ...
        # plot_datat_2(mtest_file_path, hho_file_path, len(time_steps), 1, 9, 4, 12)
        ...
        plot_datat_2(mtest_file_path, hho_file_path, len(time_steps), 2, 9, 5, 12)
