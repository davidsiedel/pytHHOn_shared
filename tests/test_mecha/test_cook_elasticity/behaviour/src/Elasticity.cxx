...
pi.young = ElasticityParametersInitializer::getDouble(tokens[0],tokens[1]);
} else if("PoissonRatio"==tokens[0]){
pi.nu = ElasticityParametersInitializer::getDouble(tokens[0],tokens[1]);
