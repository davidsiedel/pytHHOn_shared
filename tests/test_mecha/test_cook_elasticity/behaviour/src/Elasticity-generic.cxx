...
MFRONT_SHAREDOBJ unsigned short Elasticity_nMaterialProperties = 0u;

MFRONT_SHAREDOBJ const char * const *Elasticity_MaterialProperties = nullptr;
...
MFRONT_SHAREDOBJ unsigned short Elasticity_nParameters = 4;
MFRONT_SHAREDOBJ const char * Elasticity_Parameters[4] = {"YoungModulus",
...
MFRONT_SHAREDOBJ double Elasticity_YoungModulus_ParameterDefaultValue = 1.12499998125;

MFRONT_SHAREDOBJ double Elasticity_PoissonRatio_ParameterDefaultValue = 0.4999;
