...
class TestMecha(TestCase):
    def test_square_traction_y_small_strain_linear_hardening(self):
        ...
        mtest_file_path = (
            "/home/dsiedel/Projects/pythhon/behaviour/testfront/traction_y_small_strain_isotropic_linear_hardening.res"
        )
