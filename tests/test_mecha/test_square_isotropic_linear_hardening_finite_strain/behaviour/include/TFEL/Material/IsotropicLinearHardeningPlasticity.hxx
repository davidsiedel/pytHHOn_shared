...
#line 23 "isotropic_linear_hardening_finite_strain.mfront"
real young;
#line 25 "isotropic_linear_hardening_finite_strain.mfront"
real nu;
#line 27 "isotropic_linear_hardening_finite_strain.mfront"
real H;
#line 29 "isotropic_linear_hardening_finite_strain.mfront"
real s0;
...
#line 41 "isotropic_linear_hardening_finite_strain.mfront"
const auto lambda = computeLambda((this->young),(this->nu));
#line 42 "isotropic_linear_hardening_finite_strain.mfront"
const auto mu     = computeMu((this->young),(this->nu));
#line 43 "isotropic_linear_hardening_finite_strain.mfront"
...
const auto lambda = computeLambda(this->young,this->nu);
#line 52 "isotropic_linear_hardening_finite_strain.mfront"
const auto mu     = computeMu(this->young,this->nu);
#line 53 "isotropic_linear_hardening_finite_strain.mfront"
this->eel += this->deto;
#line 54 "isotropic_linear_hardening_finite_strain.mfront"
const auto se     = 2*mu*deviator(this->eel);
#line 55 "isotropic_linear_hardening_finite_strain.mfront"
const auto seq_e  = sigmaeq(se);
#line 56 "isotropic_linear_hardening_finite_strain.mfront"
const auto b      = seq_e-this->s0-this->H*this->p>stress{0};
#line 57 "isotropic_linear_hardening_finite_strain.mfront"
if(b){
#line 58 "isotropic_linear_hardening_finite_strain.mfront"
