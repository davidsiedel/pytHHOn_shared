...
IsotropicLinearHardeningPlasticityIntegrationData&
>::type
scale(const IsotropicLinearHardeningPlasticityBehaviourData<hypothesis,Type,false>&, const Scal time_scaling_factor){
...
*/
IsotropicLinearHardeningPlasticityIntegrationData&
updateDrivingVariables(const IsotropicLinearHardeningPlasticityBehaviourData<hypothesis,Type,false>&){
return *this;
}
