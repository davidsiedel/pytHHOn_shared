...
#line 16 "isotropic_linear_hardening_small_strain.mfront"
StrainStensor deel;
#line 18 "isotropic_linear_hardening_small_strain.mfront"
strain dp;


#line 21 "isotropic_linear_hardening_small_strain.mfront"
real young;
#line 23 "isotropic_linear_hardening_small_strain.mfront"
real nu;
#line 25 "isotropic_linear_hardening_small_strain.mfront"
real H;
#line 27 "isotropic_linear_hardening_small_strain.mfront"
real s0;
...
#line 39 "isotropic_linear_hardening_small_strain.mfront"
const auto lambda = computeLambda((this->young),(this->nu));
#line 40 "isotropic_linear_hardening_small_strain.mfront"
const auto mu     = computeMu((this->young),(this->nu));
#line 41 "isotropic_linear_hardening_small_strain.mfront"
...
#line 49 "isotropic_linear_hardening_small_strain.mfront"
const auto lambda = computeLambda(this->young,this->nu);
#line 50 "isotropic_linear_hardening_small_strain.mfront"
const auto mu     = computeMu(this->young,this->nu);
#line 51 "isotropic_linear_hardening_small_strain.mfront"
this->eel += this->deto;
#line 52 "isotropic_linear_hardening_small_strain.mfront"
const auto se     = 2*mu*deviator(this->eel);
#line 53 "isotropic_linear_hardening_small_strain.mfront"
const auto seq_e  = sigmaeq(se);
#line 54 "isotropic_linear_hardening_small_strain.mfront"
const auto b      = seq_e-this->s0-this->H*this->p>stress{0};
#line 55 "isotropic_linear_hardening_small_strain.mfront"
if(b){
#line 56 "isotropic_linear_hardening_small_strain.mfront"
const auto iseq_e = 1/seq_e;
#line 57 "isotropic_linear_hardening_small_strain.mfront"
const auto n      = eval(3*se/(2*seq_e));
#line 58 "isotropic_linear_hardening_small_strain.mfront"
const auto cste   = 1/(this->H+3*mu);
#line 59 "isotropic_linear_hardening_small_strain.mfront"
this->dp   = (seq_e-this->s0-this->H*this->p)*cste;
#line 60 "isotropic_linear_hardening_small_strain.mfront"
this->eel -= this->dp*n;
#line 61 "isotropic_linear_hardening_small_strain.mfront"
if(computeTangentOperator_){
#line 62 "isotropic_linear_hardening_small_strain.mfront"
if(smt==CONSISTENTTANGENTOPERATOR){
#line 63 "isotropic_linear_hardening_small_strain.mfront"
this->Dt = (lambda*Stensor4::IxI()+2*mu*Stensor4::Id()
#line 64 "isotropic_linear_hardening_small_strain.mfront"
-4*mu*mu*(this->dp*iseq_e*(Stensor4::M()-(n^n))+cste*(n^n)));
#line 65 "isotropic_linear_hardening_small_strain.mfront"
} else {
#line 66 "isotropic_linear_hardening_small_strain.mfront"
this->Dt = lambda*Stensor4::IxI()+2*mu*Stensor4::Id();
#line 67 "isotropic_linear_hardening_small_strain.mfront"
}
#line 68 "isotropic_linear_hardening_small_strain.mfront"
}
#line 69 "isotropic_linear_hardening_small_strain.mfront"
} else {
#line 70 "isotropic_linear_hardening_small_strain.mfront"
if(computeTangentOperator_){
#line 71 "isotropic_linear_hardening_small_strain.mfront"
this->Dt = lambda*Stensor4::IxI()+2*mu*Stensor4::Id();
#line 72 "isotropic_linear_hardening_small_strain.mfront"
}
#line 73 "isotropic_linear_hardening_small_strain.mfront"
}
#line 74 "isotropic_linear_hardening_small_strain.mfront"
